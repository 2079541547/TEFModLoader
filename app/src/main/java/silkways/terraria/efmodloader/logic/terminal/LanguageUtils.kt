...
class LanguageUtils(private val context: Context, private val language: String, private val assetsPath: String) {
    companion object {
        private const val ASSETS_FOLDER = "TEFModLoader/command/"
    ...
    fun getString(): String {
        val json = cachedJson
        val assetsObject = json.getString(assetsPath)
        EFLog.d("成功获取代码 '$assetsPath' 对应的文本: $assetsObject")
        return assetsObject
    }
