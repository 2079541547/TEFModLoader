...
std::vector<uint8_t> SilkCasket::Compress::LZ4::compress(const vector<uint8_t> &data, size_t blockSize) {
    auto tempFilePath = filesystem::temp_directory_path() / "temp_compressed_data.lz4";
