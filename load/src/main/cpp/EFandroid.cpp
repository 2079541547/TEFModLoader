...
std::string agreement_str = R"raw(
**EFModLoader 协议和声明**
...
Java_eternal_future_efmodloader_load_Loader_getContext(JNIEnv *env, jclass clazz) {
...
Java_eternal_future_efmodloader_load_Loader_getAgreement(JNIEnv *env, jclass clazz) {
