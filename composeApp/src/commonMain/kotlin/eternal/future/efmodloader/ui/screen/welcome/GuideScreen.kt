...
import eternal.future.efmodloader.State.defaultLoader
                ...
                state.let { (screen, _) ->
                    if (screen != null) {
                        when (screen.id) {
                            ...
                            "disposition" -> Disposition({ eternal.future.efmodloader.ui.screen.welcome.GuideScreen.disposition() })
...
@Composable
expect fun eternal.future.efmodloader.ui.screen.welcome.GuideScreen.disposition()

@Composable
expect fun eternal.future.efmodloader.ui.screen.welcome.GuideScreen.disposition_2()