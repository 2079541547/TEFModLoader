...
object Apk {
    ...
    fun modifyManifest(filePath: String, actionType: Int, addDebuggable: Boolean, updateVersionCode: Boolean) {
        ...
        val newServiceNode = createServiceElement(document, "eternal.future.TEFModLoaderService")
        applicationNode.appendChild(newServiceNode)

        println("New activity node created and appended to application node.")
        manifestNode.setAttributeNS("http://schemas.android.com/apk/res/android", "android:sharedUserId", "silkways.terraria.efmodloader")
        println("SharedUserId attribute set.")
